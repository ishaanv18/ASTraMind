...
public class GraphController {
    ...
    public ResponseEntity<Map<String, Object>> getClassDependencyGraph(@PathVariable String id) {
    ...
    public ResponseEntity<?> getClassDependencies(@PathVariable String id) {
    ...
    public ResponseEntity<?> getClassDependents(@PathVariable String id) {
