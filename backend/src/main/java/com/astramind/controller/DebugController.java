...
public class DebugController {
    ...
    public Map<String, Object> getEmbeddingTypes(@PathVariable String codebaseId) {
        Map<String, Object> result = new HashMap<>();

        try {
            // Get all embeddings for this codebase
            List<com.astramind.model.CodeEmbedding> embeddings = codeEmbeddingRepository.findByCodeFileId(codebaseId);
