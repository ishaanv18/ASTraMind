...
public class MetricsController {
    ...
    public ResponseEntity<Map<String, Object>> getCodebaseMetrics(@PathVariable String id) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> calculateMetrics(@PathVariable String id) {
        try {
